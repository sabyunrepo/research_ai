...
사람 신입사원이라면 어떤 제품인지, 누가 보는 보고서인지, 어떤 보고서 형식인지 먼저 물어봐야 한다고 설명한다.
...
```text
팀장 말풍선과 김아이 머리 위의 제품, 보는 사람, 보고서 형식 빈칸.
```
...
우수사원 프로젝트의 단계로 소개한다. 먼저 책상을 정리하고, 그다음 업무 지시서를 쓰고, 데스크 자료를 고르고, 반복 절차를 매뉴얼로 남기고, 역할과 도구를 나누고, 마지막에 체크리스트로 확인한다고 말한다.
