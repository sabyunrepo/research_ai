...
This mirror captures the core `deck-harness/workflow.md` contract for planning and review. Generated deck workers should treat `deck-harness/workflow.md` as the executable harness source and this file as the docs-facing reference.
