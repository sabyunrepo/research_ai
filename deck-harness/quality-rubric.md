...
This rubric is the reusable quality bar for any deck generated through `deck-harness/`. `lecture-cuts/` is the golden reference for structure, evidence habits, presenter separation, glossary behavior, browser fit, and handoff completeness.
