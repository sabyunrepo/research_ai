window.LECTURE_SLIDES = [
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        ...
        "bridge": "먼저 오래 생각하라는 주문보다 명확한 기준이 왜 중요한지 보겠습니다."
      }
    },
    "sources": [
      {
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "프롬프트 레이어의 첫 전환으로, 장황한 생각 지시보다 명확한 목표와 기준이 중요하다는 문제의식을 잡는다.",
        "keywords": [
          "추론형 모델",
          "생각 지시",
          "목표",
        ...
        "flow": [
          "단계별로 생각해를 습관처럼 붙이는 문제를 꺼낸다",
          "최신 추론형 모델에는 목표와 조건이 더 중요하다고 전환한다",
          "기준을 선명하게 주려면 입력 경계가 필요하다고 넘긴다"
        ],
        "example": "복잡한 요청에 생각 과정을 요구하기보다 목표, 조건, 체크리스트를 짧게 주는 예를 든다.",
        "bridge": "다음은 입력 경계를 나눠 모델의 오독을 줄이는 방법입니다."
      }
    },
    "sectionId": "03",
    "sectionTitle": "Spec / Prompt",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "명확한 기준을 실제 입력 구조로 만들기 위해 지시, 참고 자료, 제약, 출력 형식의 경계를 나누게 한다.",
        "keywords": [
          "입력 경계",
          "XML",
          "섹션",
        ...
        "flow": [
          "기준이 문장 속에 섞이면 다시 오독이 생긴다고 말한다",
          "지시와 참고 자료와 출력 형식을 분리한다",
          "경계가 잡힌 입력을 여섯 칸 요청서로 정리하겠다고 넘긴다"
        ],
        "example": "작업 지시서, 참고 도면, 출력 양식을 서로 다른 서류함에 넣는다고 비유한다.",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "AI가 일을 시작하기 전에 필요한 정보를 여섯 칸 작업 발주서로 나눠 추측할 빈칸을 줄인다.",
        "keywords": [
          "요청서",
          "목표",
          "증상",
        ...
        "flow": [
          "좋은 요청은 긴 문단이 아니라 작업 발주서라고 설명한다",
          "목표, 증상, 범위, 제약, 검증, 보고의 여섯 칸을 소개한다",
          "검증과 보고는 완료 판정이 아니라 답변 형식을 정리하는 칸으로 제한한다"
        ],
        "example": "결제 실패 수정 요청을 목표, 증상, 범위, 제한, 검증, 보고로 나눈다.",
        "bridge": "다음은 완료를 선언이 아니라 증거로 판단하는 기준입니다."
      }
    },
    "sectionId": "03",
    "sectionTitle": "Spec / Prompt",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "AI의 완료 선언을 그대로 믿지 않고 실행 결과, 검증 증거, 남은 위험으로 종료 여부를 판단하게 한다.",
        "keywords": [
          "완료 선언",
          "실행 증거",
          "검증 결과",
        ...
        "flow": [
          "시작을 잘 시키는 것과 완료를 믿는 것은 다르다고 전환한다",
          "결과물, 실행 증거, 남은 위험을 나눠 받게 한다",
          "증거를 merge, 재검토, 추가 테스트 같은 다음 행동으로 연결한다"
        ],
        "example": "결제 오류 수정 보고에서 통과한 테스트와 확인 못 한 PG 연동 위험을 분리한다.",
        "bridge": "다음은 작업 성격에 따라 요청 강도를 조절하는 방법입니다."
      }
    },
    "sectionId": "03",
    "sectionTitle": "Spec / Prompt",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        ...
        "flow": [
          "여섯 칸 요청과 완료 증거를 배운 뒤 생기는 과잉 지시 문제를 꺼낸다",
          "간단한 일, 형식이 중요한 일, 위험한 일을 나눠 설명한다",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "어떤 반복 업무를 스킬로 승격할지 판단하는 기준을 설명한다.",
        "keywords": [
          "스킬",
          "반복",
          "판단 기준",
        ...
        "flow": [
          "모든 프롬프트가 스킬 후보는 아니라고 선을 긋는다",
          "반복성, 판단 기준, 실패 비용, 부속 자료로 승격 여부를 판단한다",
          "스킬 구조 설명으로 넘긴다"
        ],
        "example": "한국어 문장 검교정, 발표자 스크립트 리뷰, 보안 리뷰, PR 설명 작성처럼 매번 같은 기준이 필요한 일을 든다.",
        "bridge": "다음은 “스킬은 호출 조건, 절차, 자료를 분리합니다”입니다."
      }
    },
    "sectionId": "05",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "스킬의 description, 본문, references, scripts, assets가 각각 맡는 역할을 명확히 설명한다.",
        "keywords": [
          "description",
          "본문",
          "references",
        ...
        "flow": [
          "SKILL.md 하나에 모든 내용을 넣는 실수를 지적한다",
          "호출 조건, 실행 절차, 긴 자료, 실행 코드, 재사용 파일을 분리한다",
          "실제 폴더 예시로 넘긴다"
        ],
        "example": "좋은 예시와 나쁜 예시는 references, 검증 명령은 scripts, 템플릿과 샘플 입력은 assets로 나누는 상황을 든다.",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "실제 스킬 폴더를 에이전트가 읽고 실행하는 순서로 설명한다.",
        "keywords": [
          "deck-builder",
          "SKILL.md",
          "references",
        ...
        "flow": [
          "27번의 구성요소 책임 설명을 실제 폴더 읽기 순서로 전환한다",
          "SKILL.md, references, scripts, assets를 실행 흐름으로 따라간다",
          "Superpowers로 연결한다"
        ],
        "example": "deck-builder 폴더에서 SKILL.md를 먼저 읽고, 막히면 references를 보고, 반복 검증은 scripts로 실행하는 순서를 든다.",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        ...
        "example": "개발자, 리뷰어, 리서처를 한 사람에게 몰아주지 않고 역할을 나누는 상황으로 설명한다.",
        "bridge": "다음은 “에이전트 도구는 권한과 개수를 좁혀야 합니다”입니다."
      }
    },
    "sectionId": "06",
    "sectionTitle": "Agents / Tools",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "에이전트가 실제 일을 수행할 때 필요한 도구 권한과 tool bloat 위험을 먼저 설명한다.",
        "keywords": [
          "도구",
          "read-only",
          "write-capable",
        ...
        "flow": [
          "역할을 나눴다면 역할별 도구가 필요하다고 연결한다",
          "읽기 도구와 쓰기 도구의 위험도를 나눈다",
          "도구 개수를 줄여 선택 비용을 낮춘다고 정리한다"
        ],
        "example": "Researcher는 검색 도구, Reviewer는 PR 조회 도구가 필요하지만 merge 같은 쓰기 도구는 승인 게이트가 필요하다고 말한다.",
        "bridge": "다음은 “MCP는 도구 연결을 표준화합니다”입니다."
      }
    },
    "sectionId": "06",
    "sectionTitle": "Agents / Tools",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "도구 권한 설명 다음에 MCP가 필요한 이유를 표준화 문제로 연결한다.",
        "keywords": [
          "도구 연결",
          "표준화",
          "MCP",
        ...
        "flow": [
          "도구를 붙이기 시작하면 연결 방식이 흩어진다고 말한다",
          "설명, 권한, 호출 방식이 제각각이면 운영이 어려워진다고 설명한다",
          "MCP는 외부 기능 제공 방식을 표준화하는 연결 규격이라고 정의한다"
        ],
        "example": "GitHub, DB, Browser 도구를 앱마다 따로 붙이는 대신 MCP라는 같은 규격으로 제공한다고 말한다.",
        "bridge": "다음은 “MCP는 Host, Client, Server로 연결됩니다”입니다."
      }
    },
    "sectionId": "06",
    "sectionTitle": "Agents / Tools",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "MCP의 큰 연결 방향을 Host, Client, Server 세 덩어리로 설명한다.",
        "keywords": [
          "Host",
          "Client",
          "Server",
        ...
        "flow": [
          "앞 장은 MCP가 필요한 이유였고, 이 장은 연결 방향이라고 구분한다",
          "Host는 Claude/Codex 같은 AI 앱이라고 설명한다",
          "Client는 연결 통로, Server는 외부 기능 제공자라고 정리한다"
        ],
        "example": "Claude나 Codex가 내부 Client를 통해 GitHub MCP Server에 연결된다고 말한다.",
        "bridge": "다음은 “MCP 서버는 세 가지를 제공합니다”입니다."
      }
    },
    "sectionId": "06",
    "sectionTitle": "Agents / Tools",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "MCP Server가 제공하는 Tools, Resources, Prompts를 분리해서 설명한다.",
        "keywords": [
          "Tools",
          "Resources",
          "Prompts",
        ...
        "flow": [
          "Tool만 MCP가 아니라고 먼저 잡는다",
          "Tools는 실행 호출, Resources는 읽기 자료, Prompts는 재사용 템플릿이라고 나눈다",
          "운영 위험은 주로 Tools 권한에서 생긴다고 앞 슬라이드와 연결한다"
        ],
        "example": "GitHub MCP Server가 PR 조회 Tool, 저장소 문서 Resource, 리뷰 Prompt를 제공할 수 있다고 말한다.",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        ...
        "flow": [
          "역할, 도구 권한, MCP 연결 구조를 실습으로 묶는다고 말한다",
  ...
  },
  {
    ...
    "speaker": {
      ...
      "cues": {
        "purpose": "Judge와 사람 검토가 감상평 대신 요구사항, 영향, 위험, 근거 질문으로 판단하게 한다.",
        "keywords": [
          "rubric",
          "요구사항",
          "영향",
        ...
        "flow": [
          "Machine/Judge/Human 분류 중 Judge의 실제 질문으로 좁힌다",
          "요구사항, 영향, 위험, 근거를 순서대로 묻는다",
          "Loop 운영으로 연결한다"
        ],
        "example": "테스트는 통과했지만 요구사항 범위, 사용자 체감 변화, 운영 위험, 화면 증거를 차례로 확인하는 상황을 든다.",
